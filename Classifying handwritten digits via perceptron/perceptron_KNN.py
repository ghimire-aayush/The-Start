...
## This code attempts to distinguish the handwritten numbers using both the simple perceptron and KNN alogrithm
## We use the infamous minst dataset which includes handwirtten digits along with their corresponding numbers
...
def get_images(filename):
    ...
    Transforms (0, 1) values to (-1.0, 1.0)
    """
    dir_path = os.path.dirname(os.path.realpath(__file__))
    vectors = []
...
class NearestNeighbour:
    ...
    def train(self, test_vector):
        ...
        for e in self.data[:500]:  #500 is just arbitrary
...
def main():
    ...
    perc.train('3', '5', 100)
    print(f"Perceptron accurracy is {perc.test('3', '5')}")
